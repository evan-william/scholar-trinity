    ...
    <div class="grid">
        <div class="card">
            ...
            <table>
                ...
                <tr><td>Passport / 護照</td><td>{{ $registration->passport_upload_status === 'pending_review' ? 'Uploaded, pending review / 已上傳，待審核' : 'Pending coordinator review / 待協調員確認' }}</td></tr>
            </table>
        </div>
        <div class="card">
            ...
            <table>
                ...
                <tr><td>Emergency / 緊急聯絡人</td><td>{{ $registration->contact?->emergency_contact_name ?: '-' }} {{ $registration->contact?->emergency_contact_phone ? '/ '.$registration->contact->emergency_contact_phone : '' }}</td></tr>
            </table>
        </div>
    </div>
