...
(function($) {
    ...
    function slider_area() {
        $('.slider-area').owlCarousel({
            ...
            items: 1,
            smartSpeed: 800,
            navText: ['<i><img src="/theme/edification/images/angle-left.png" alt="icon"/></i><span>prev</span>', '<span>next</span><i><img src="/theme/edification/images/angle-right.png" alt="icon"/></i>']
        });
    };
    slider_area();
