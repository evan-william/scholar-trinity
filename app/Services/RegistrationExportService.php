        ...
        return $registrations->flatMap(function (StudentRegistration $registration) use ($includeNotes, $maskPassport, $template): array {
            ...
            return $exams->map(function ($exam) use ($registration, $includeNotes, $maskPassport, $template): array {
                $row = [
                    ...
                    'Student Signature' => $registration->student_signature_name,
                    'Student Signature Date' => optional($registration->student_signature_date)->format('Y-m-d'),
                    'Guardian Signature' => $registration->guardian_signature_name,
                    'Guardian Signature Date' => optional($registration->guardian_signature_date)->format('Y-m-d'),
