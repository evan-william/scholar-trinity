...
class StoreStudentRegistrationRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'accurate_information.accepted' => __('ap_registration.form.review_form'),
            'ap_policies.accepted' => __('ap_registration.form.review_form'),
            'privacy_policy.accepted' => __('ap_registration.form.review_form'),
            'terms_conditions.accepted' => __('ap_registration.form.review_form'),
