...
class StudentRegistration extends Model
{
    ...
    protected $casts = [
        ...
        'accommodations_payload' => 'array',
        'practice_exam_count' => 'integer',
        'practice_exam_total' => 'integer',
        'preparation_interest' => 'boolean',
        'primacy_email_opt_in' => 'boolean',
        'group_class_interest' => 'boolean',
